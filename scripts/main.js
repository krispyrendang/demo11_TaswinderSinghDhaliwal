// Always check if someone is logged in.   
// If yes, then assign a global variable for the user.    
...
//Same as the original writeHikes() but with numerical values and timestamps to allow sorting by value.
function writeHikesNew() {
    //define a variable for the collection you want to create in Firestore to populate data
    var hikesRef = db.collection("Hikes");
